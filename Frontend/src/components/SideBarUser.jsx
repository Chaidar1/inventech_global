...
export default function SideBarUser({ 
  ...
  // Custom Icon Components dengan styling yang lebih menarik untuk User
  const CustomIcons = {
    Profile: () => (
    ...
    <>
      ...
      >
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <p className={`font-semibold truncate ${
                  ...
                  {profile?.nama_lengkap || profile?.username || "User"}
                </p>
        ...
        <div className="flex-1 p-4 space-y-2 overflow-y-auto">
          ...
          {/* PERBAIKAN: Ganti path dari "/about" menjadi "/tentang-kami" */}
          <button
